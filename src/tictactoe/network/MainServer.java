...
/*
 * Classe responsável por fazer a conexão de dois jogadores no servidor principal, de porta fixa.
 */
	...
	public static void main(String[] args) {
		try {
			...
			for (;;) {
				 ...
				 * jogadores por parâmetro.
				 */
				TicTacToeThread game = new TicTacToeThread(client1, client2, player1Name, player2Name);
				game.start();
				/*
				 * Adição dos jogadores em uma lista para controle do servidor,
				 * visando implementações futuras.
				 */
